...
export async function GET(req: Request) {
  ...
  try {
    ...
    const vertexTargetsData = await db.all<VertexTarget[]>('SELECT * FROM vertex_targets'); // Changed api_keys to vertex_targets, ApiKey to VertexTarget, apiKeysData to vertexTargetsData
    ...
    const exportData = {
      ...
      data: {
        vertex_targets: vertexTargetsData || [], // Changed api_keys to vertex_targets, apiKeysData to vertexTargetsData
