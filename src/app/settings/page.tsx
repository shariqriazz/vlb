        ...
        <SimpleGrid columns={{ base: 1, lg: 2 }} gap={6} mb={6}> {/* Adjusted grid columns and added margin */}
          ...
          <Card bg={cardBg} borderWidth="1px" borderColor={borderColor} borderRadius="lg" shadow="sm">
            ...
            <CardBody>
              ...
              <FormControl mb={4}> {/* Add maxRetries field */}
                <FormLabel>Max Retries on Failure</FormLabel>
                <NumberInput
                  value={settings.maxRetries ?? 3} // Use nullish coalescing for default
                  onChange={(_, value) => setSettings({ ...settings, maxRetries: value })}
                ...
                <Text fontSize="sm" color="gray.500" mt={1}>
                  Maximum number of retries for a request before failing over (0 to disable).
                </Text>
              </FormControl>
